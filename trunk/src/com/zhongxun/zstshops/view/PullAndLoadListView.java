...
public class PullAndLoadListView extends PullToRefreshListView {
	...
	protected static final String TAG = "PullAndLoadListView";
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (mOnLoadMoreListener != null) {
            System.out.println(visibleItemCount +"=="+ totalItemCount);
			if (visibleItemCount == totalItemCount) {
				mProgressBarLoadMore.setVisibility(View.GONE);
				// mLabLoadMore.setVisibility(View.GONE);
				MyLog.e(TAG, visibleItemCount +"=="+ totalItemCount);
				return;
			}

			boolean loadMore = firstVisibleItem + visibleItemCount >= totalItemCount;
            MyLog.e(TAG, loadMore+""+" isloading--"+mIsLoadingMore);
